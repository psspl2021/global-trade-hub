...
Suppliers operate as verified fulfilment partners.`,
  ...
  // ============================
  // PHASE-2 BATCH-2 — REVENUE ENTERPRISE PAGES (31–35)
  // ============================

  // 31) Energy & Power Equipment
  { slug: 'energy-power-equipment', h1: 'Energy & Power Equipment Procurement for EPC and Utilities', subheading: 'Enterprise sourcing for power plants, renewables, and backup infrastructure.', bodyText: 'ProcureSaathi manages large-scale procurement of power generation, transmission, and storage equipment for EPC contractors, utilities, and renewable developers.', useCases: ['Solar power plants', 'Battery energy storage systems', 'Utility substations', 'Backup power systems'], whatBuyerGets: ['Single EPC-aligned pricing', 'OEM & Tier-1 sourcing', 'Export + domestic supply', 'Contract with ProcureSaathi Pvt Ltd'], specifications: ['Solar panels', 'Inverters', 'UPS systems', 'Industrial batteries', 'Transformers'], metaTitle: 'Energy & Power Equipment Procurement | Solar Batteries UPS EPC', metaDescription: 'Managed procurement for power plants, solar projects, batteries and UPS. EPC & utility grade supply.', intentKeywords: ['solar power equipment procurement', 'battery energy storage sourcing', 'UPS bulk supply', 'power plant procurement'], signalMapping: { category: 'energy_power', subcategory: 'power_equipment', industry: 'power_infra', buyer_type: 'epc_utility', estimated_value_band: 'very_high', signal_source: 'signal_page' }, verifiedSuppliersCount: 65, successfulDealsCount: 142, typicalDealRange: { min: 20000000, max: 800000000 }, deliveryTimeline: '20–60 days' },
  { slug: 'solar-power-equipment', canonicalSlug: 'energy-power-equipment', h1: 'Solar Power Equipment', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'Solar Power Equipment Procurement', metaDescription: 'Solar power equipment procurement.', intentKeywords: [], signalMapping: { category: 'energy_power', subcategory: 'power_equipment', industry: 'power_infra', buyer_type: 'epc_utility', estimated_value_band: 'very_high', signal_source: 'signal_page' }, verifiedSuppliersCount: 65, successfulDealsCount: 142, typicalDealRange: { min: 20000000, max: 800000000 }, deliveryTimeline: '20–60 days' },
  { slug: 'battery-energy-storage-systems', canonicalSlug: 'energy-power-equipment', h1: 'Battery Energy Storage Systems', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'Battery Energy Storage Systems', metaDescription: 'BESS procurement.', intentKeywords: [], signalMapping: { category: 'energy_power', subcategory: 'power_equipment', industry: 'power_infra', buyer_type: 'epc_utility', estimated_value_band: 'very_high', signal_source: 'signal_page' }, verifiedSuppliersCount: 65, successfulDealsCount: 142, typicalDealRange: { min: 20000000, max: 800000000 }, deliveryTimeline: '20–60 days' },
  { slug: 'ups-industrial-supply', canonicalSlug: 'energy-power-equipment', h1: 'UPS Industrial Supply', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'UPS Industrial Supply', metaDescription: 'Industrial UPS procurement.', intentKeywords: [], signalMapping: { category: 'energy_power', subcategory: 'power_equipment', industry: 'power_infra', buyer_type: 'epc_utility', estimated_value_band: 'very_high', signal_source: 'signal_page' }, verifiedSuppliersCount: 65, successfulDealsCount: 142, typicalDealRange: { min: 20000000, max: 800000000 }, deliveryTimeline: '20–60 days' },
  { slug: 'solar-inverter-procurement', canonicalSlug: 'energy-power-equipment', h1: 'Solar Inverter Procurement', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'Solar Inverter Procurement', metaDescription: 'Solar inverter sourcing.', intentKeywords: [], signalMapping: { category: 'energy_power', subcategory: 'power_equipment', industry: 'power_infra', buyer_type: 'epc_utility', estimated_value_band: 'very_high', signal_source: 'signal_page' }, verifiedSuppliersCount: 65, successfulDealsCount: 142, typicalDealRange: { min: 20000000, max: 800000000 }, deliveryTimeline: '20–60 days' },
  { slug: 'renewable-energy-procurement', canonicalSlug: 'energy-power-equipment', h1: 'Renewable Energy Procurement', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'Renewable Energy Procurement', metaDescription: 'Renewable energy equipment sourcing.', intentKeywords: [], signalMapping: { category: 'energy_power', subcategory: 'power_equipment', industry: 'power_infra', buyer_type: 'epc_utility', estimated_value_band: 'very_high', signal_source: 'signal_page' }, verifiedSuppliersCount: 65, successfulDealsCount: 142, typicalDealRange: { min: 20000000, max: 800000000 }, deliveryTimeline: '20–60 days' },
  { slug: 'bess-procurement', canonicalSlug: 'energy-power-equipment', h1: 'BESS Procurement', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'BESS Procurement', metaDescription: 'Battery energy storage system procurement.', intentKeywords: [], signalMapping: { category: 'energy_power', subcategory: 'power_equipment', industry: 'power_infra', buyer_type: 'epc_utility', estimated_value_band: 'very_high', signal_source: 'signal_page' }, verifiedSuppliersCount: 65, successfulDealsCount: 142, typicalDealRange: { min: 20000000, max: 800000000 }, deliveryTimeline: '20–60 days' },
  { slug: 'power-plant-equipment', canonicalSlug: 'energy-power-equipment', h1: 'Power Plant Equipment', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'Power Plant Equipment', metaDescription: 'Power plant equipment procurement.', intentKeywords: [], signalMapping: { category: 'energy_power', subcategory: 'power_equipment', industry: 'power_infra', buyer_type: 'epc_utility', estimated_value_band: 'very_high', signal_source: 'signal_page' }, verifiedSuppliersCount: 65, successfulDealsCount: 142, typicalDealRange: { min: 20000000, max: 800000000 }, deliveryTimeline: '20–60 days' },

  // 32) Industrial Pipes & Tubes – Oil Gas Power
  { slug: 'industrial-pipes-tubes-oil-gas', h1: 'Industrial Pipes & Tubes Procurement for Oil, Gas & Power Projects', subheading: 'API, boiler and DI pipe sourcing for EPC and refinery projects.', bodyText: 'ProcureSaathi manages procurement of critical piping systems for refineries, pipelines, power plants and water infrastructure.', useCases: ['Oil & gas pipelines', 'Boiler systems', 'Water transmission', 'Refinery piping'], whatBuyerGets: ['API / ASTM compliant pipes', 'Third-party inspection', 'Project scheduling', 'Contract with ProcureSaathi Pvt Ltd'], specifications: ['API 5L', 'Boiler tubes', 'DI pipes', 'Line pipes'], metaTitle: 'API & Boiler Pipe Procurement | Oil Gas EPC Pipes', metaDescription: 'Managed sourcing of API line pipes, boiler tubes and DI pipes for EPC and oil & gas projects.', intentKeywords: ['API pipe procurement', 'boiler tube sourcing', 'line pipe supply', 'DI pipe bulk'], signalMapping: { category: 'pipes', subcategory: 'api_boiler_di_pipes', industry: 'oil_gas_power', buyer_type: 'epc_contractor', estimated_value_band: 'very_high', signal_source: 'signal_page' }, verifiedSuppliersCount: 80, successfulDealsCount: 210, typicalDealRange: { min: 15000000, max: 1000000000 }, deliveryTimeline: '25–70 days' },
  { slug: 'api-line-pipes', canonicalSlug: 'industrial-pipes-tubes-oil-gas', h1: 'API Line Pipes', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'API Line Pipes Procurement', metaDescription: 'API line pipes sourcing.', intentKeywords: [], signalMapping: { category: 'pipes', subcategory: 'api_boiler_di_pipes', industry: 'oil_gas_power', buyer_type: 'epc_contractor', estimated_value_band: 'very_high', signal_source: 'signal_page' }, verifiedSuppliersCount: 80, successfulDealsCount: 210, typicalDealRange: { min: 15000000, max: 1000000000 }, deliveryTimeline: '25–70 days' },
  { slug: 'boiler-tubes-procurement', canonicalSlug: 'industrial-pipes-tubes-oil-gas', h1: 'Boiler Tubes Procurement', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'Boiler Tubes Procurement', metaDescription: 'Boiler tubes sourcing.', intentKeywords: [], signalMapping: { category: 'pipes', subcategory: 'api_boiler_di_pipes', industry: 'oil_gas_power', buyer_type: 'epc_contractor', estimated_value_band: 'very_high', signal_source: 'signal_page' }, verifiedSuppliersCount: 80, successfulDealsCount: 210, typicalDealRange: { min: 15000000, max: 1000000000 }, deliveryTimeline: '25–70 days' },
  { slug: 'di-pipes-water-projects', canonicalSlug: 'industrial-pipes-tubes-oil-gas', h1: 'DI Pipes Water Projects', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'DI Pipes Water Projects', metaDescription: 'DI pipes for water projects.', intentKeywords: [], signalMapping: { category: 'pipes', subcategory: 'api_boiler_di_pipes', industry: 'oil_gas_power', buyer_type: 'epc_contractor', estimated_value_band: 'very_high', signal_source: 'signal_page' }, verifiedSuppliersCount: 80, successfulDealsCount: 210, typicalDealRange: { min: 15000000, max: 1000000000 }, deliveryTimeline: '25–70 days' },
  { slug: 'oil-gas-pipe-export', canonicalSlug: 'industrial-pipes-tubes-oil-gas', h1: 'Oil Gas Pipe Export', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'Oil Gas Pipe Export', metaDescription: 'Oil gas pipe export sourcing.', intentKeywords: [], signalMapping: { category: 'pipes', subcategory: 'api_boiler_di_pipes', industry: 'oil_gas_power', buyer_type: 'epc_contractor', estimated_value_band: 'very_high', signal_source: 'signal_page' }, verifiedSuppliersCount: 80, successfulDealsCount: 210, typicalDealRange: { min: 15000000, max: 1000000000 }, deliveryTimeline: '25–70 days' },
  { slug: 'refinery-piping-supply', canonicalSlug: 'industrial-pipes-tubes-oil-gas', h1: 'Refinery Piping Supply', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'Refinery Piping Supply', metaDescription: 'Refinery piping procurement.', intentKeywords: [], signalMapping: { category: 'pipes', subcategory: 'api_boiler_di_pipes', industry: 'oil_gas_power', buyer_type: 'epc_contractor', estimated_value_band: 'very_high', signal_source: 'signal_page' }, verifiedSuppliersCount: 80, successfulDealsCount: 210, typicalDealRange: { min: 15000000, max: 1000000000 }, deliveryTimeline: '25–70 days' },

  // 33) Petroleum & Bitumen
  { slug: 'petroleum-bitumen-procurement', h1: 'Petroleum & Bitumen Procurement for Roads and Refineries', subheading: 'High-volume sourcing for highways, refineries and government tenders.', bodyText: 'ProcureSaathi manages petroleum products and bitumen procurement for NHAI projects, refineries, and industrial buyers.', useCases: ['Highway construction', 'Refinery supply', 'Airport runways', 'Industrial fuel'], whatBuyerGets: ['VG grade supply', 'Bulk logistics handling', 'Tender aligned pricing', 'Contract with ProcureSaathi Pvt Ltd'], specifications: ['Bitumen VG10/30/40', 'Emulsion bitumen', 'Furnace oil', 'Base oil'], metaTitle: 'Bitumen & Petroleum Procurement | Highway & Refinery Supply', metaDescription: 'Managed bitumen and petroleum sourcing for NHAI, highways and refineries.', intentKeywords: ['bitumen procurement', 'petroleum bulk supply', 'highway bitumen sourcing'], signalMapping: { category: 'petroleum', subcategory: 'bitumen_petroleum', industry: 'road_refinery', buyer_type: 'government_epc', estimated_value_band: 'very_high', signal_source: 'signal_page' }, verifiedSuppliersCount: 55, successfulDealsCount: 168, typicalDealRange: { min: 10000000, max: 600000000 }, deliveryTimeline: '7–30 days' },
  { slug: 'bitumen-vg10-suppliers', canonicalSlug: 'petroleum-bitumen-procurement', h1: 'Bitumen VG10 Suppliers', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'Bitumen VG10 Suppliers', metaDescription: 'Bitumen VG10 supply.', intentKeywords: [], signalMapping: { category: 'petroleum', subcategory: 'bitumen_petroleum', industry: 'road_refinery', buyer_type: 'government_epc', estimated_value_band: 'very_high', signal_source: 'signal_page' }, verifiedSuppliersCount: 55, successfulDealsCount: 168, typicalDealRange: { min: 10000000, max: 600000000 }, deliveryTimeline: '7–30 days' },
  { slug: 'bitumen-vg30-procurement', canonicalSlug: 'petroleum-bitumen-procurement', h1: 'Bitumen VG30 Procurement', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'Bitumen VG30 Procurement', metaDescription: 'Bitumen VG30 supply.', intentKeywords: [], signalMapping: { category: 'petroleum', subcategory: 'bitumen_petroleum', industry: 'road_refinery', buyer_type: 'government_epc', estimated_value_band: 'very_high', signal_source: 'signal_page' }, verifiedSuppliersCount: 55, successfulDealsCount: 168, typicalDealRange: { min: 10000000, max: 600000000 }, deliveryTimeline: '7–30 days' },
  { slug: 'nhai-bitumen-supply', canonicalSlug: 'petroleum-bitumen-procurement', h1: 'NHAI Bitumen Supply', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'NHAI Bitumen Supply', metaDescription: 'NHAI bitumen supply.', intentKeywords: [], signalMapping: { category: 'petroleum', subcategory: 'bitumen_petroleum', industry: 'road_refinery', buyer_type: 'government_epc', estimated_value_band: 'very_high', signal_source: 'signal_page' }, verifiedSuppliersCount: 55, successfulDealsCount: 168, typicalDealRange: { min: 10000000, max: 600000000 }, deliveryTimeline: '7–30 days' },
  { slug: 'highway-bitumen-bulk', canonicalSlug: 'petroleum-bitumen-procurement', h1: 'Highway Bitumen Bulk', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'Highway Bitumen Bulk', metaDescription: 'Highway bitumen bulk supply.', intentKeywords: [], signalMapping: { category: 'petroleum', subcategory: 'bitumen_petroleum', industry: 'road_refinery', buyer_type: 'government_epc', estimated_value_band: 'very_high', signal_source: 'signal_page' }, verifiedSuppliersCount: 55, successfulDealsCount: 168, typicalDealRange: { min: 10000000, max: 600000000 }, deliveryTimeline: '7–30 days' },

  // 34) Steel Fabrication & Structures
  { slug: 'steel-fabrication-structures-epc', h1: 'Steel Fabrication & Structures Procurement for Industrial EPC', subheading: 'Heavy structural fabrication sourcing for plants, bridges and warehouses.', bodyText: 'ProcureSaathi manages fabricated steel structures procurement for industrial plants, bridges, warehouses and export EPC projects.', useCases: ['Industrial plants', 'Bridges & walkways', 'Warehouses', 'Power structures'], whatBuyerGets: ['Turnkey fabrication sourcing', 'Inspection & erection support', 'Contract with ProcureSaathi Pvt Ltd'], specifications: ['MS structures', 'Cable trays', 'Steel platforms', 'Gratings & ladders'], metaTitle: 'Steel Fabrication Procurement | Industrial Structures EPC', metaDescription: 'Managed steel fabrication sourcing for EPC and infrastructure projects.', intentKeywords: ['steel fabrication procurement', 'industrial steel structures', 'epc fabrication sourcing'], signalMapping: { category: 'steel_fabrication', subcategory: 'structures', industry: 'industrial_epc', buyer_type: 'epc_contractor', estimated_value_band: 'high', signal_source: 'signal_page' }, verifiedSuppliersCount: 70, successfulDealsCount: 134, typicalDealRange: { min: 12000000, max: 500000000 }, deliveryTimeline: '30–90 days' },
  { slug: 'industrial-steel-structures', canonicalSlug: 'steel-fabrication-structures-epc', h1: 'Industrial Steel Structures', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'Industrial Steel Structures', metaDescription: 'Industrial steel structures.', intentKeywords: [], signalMapping: { category: 'steel_fabrication', subcategory: 'structures', industry: 'industrial_epc', buyer_type: 'epc_contractor', estimated_value_band: 'high', signal_source: 'signal_page' }, verifiedSuppliersCount: 70, successfulDealsCount: 134, typicalDealRange: { min: 12000000, max: 500000000 }, deliveryTimeline: '30–90 days' },
  { slug: 'heavy-steel-fabrication', canonicalSlug: 'steel-fabrication-structures-epc', h1: 'Heavy Steel Fabrication', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'Heavy Steel Fabrication', metaDescription: 'Heavy steel fabrication.', intentKeywords: [], signalMapping: { category: 'steel_fabrication', subcategory: 'structures', industry: 'industrial_epc', buyer_type: 'epc_contractor', estimated_value_band: 'high', signal_source: 'signal_page' }, verifiedSuppliersCount: 70, successfulDealsCount: 134, typicalDealRange: { min: 12000000, max: 500000000 }, deliveryTimeline: '30–90 days' },
  { slug: 'bridge-fabrication-supply', canonicalSlug: 'steel-fabrication-structures-epc', h1: 'Bridge Fabrication Supply', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'Bridge Fabrication Supply', metaDescription: 'Bridge fabrication supply.', intentKeywords: [], signalMapping: { category: 'steel_fabrication', subcategory: 'structures', industry: 'industrial_epc', buyer_type: 'epc_contractor', estimated_value_band: 'high', signal_source: 'signal_page' }, verifiedSuppliersCount: 70, successfulDealsCount: 134, typicalDealRange: { min: 12000000, max: 500000000 }, deliveryTimeline: '30–90 days' },
  { slug: 'warehouse-steel-structures', canonicalSlug: 'steel-fabrication-structures-epc', h1: 'Warehouse Steel Structures', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'Warehouse Steel Structures', metaDescription: 'Warehouse steel structures.', intentKeywords: [], signalMapping: { category: 'steel_fabrication', subcategory: 'structures', industry: 'industrial_epc', buyer_type: 'epc_contractor', estimated_value_band: 'high', signal_source: 'signal_page' }, verifiedSuppliersCount: 70, successfulDealsCount: 134, typicalDealRange: { min: 12000000, max: 500000000 }, deliveryTimeline: '30–90 days' },

  // 35) GFRP & Composites
  { slug: 'gfrp-composites-industrial', h1: 'GFRP & Composite Procurement for Water, Chemical & Export Projects', subheading: 'Corrosion-resistant composite sourcing for infrastructure and industry.', bodyText: 'ProcureSaathi manages GFRP and composite material procurement for water plants, chemical facilities and export infrastructure.', useCases: ['Water treatment plants', 'Chemical tanks', 'Cable trays', 'Industrial platforms'], whatBuyerGets: ['Design-matched sourcing', 'Export compliant supply', 'Contract with ProcureSaathi Pvt Ltd'], specifications: ['GFRP pipes', 'FRP tanks', 'Cable trays', 'Gratings & ladders'], metaTitle: 'GFRP & Composite Procurement | Industrial & Water Projects', metaDescription: 'Managed GFRP and composite sourcing for water treatment and chemical plants.', intentKeywords: ['gfrp pipe procurement', 'frp tank sourcing', 'composite material supply'], signalMapping: { category: 'composites', subcategory: 'gfrp_frp', industry: 'water_chemical', buyer_type: 'industrial_epc', estimated_value_band: 'high', signal_source: 'signal_page' }, verifiedSuppliersCount: 48, successfulDealsCount: 96, typicalDealRange: { min: 8000000, max: 300000000 }, deliveryTimeline: '20–60 days' },
  { slug: 'gfrp-pipes-procurement', canonicalSlug: 'gfrp-composites-industrial', h1: 'GFRP Pipes Procurement', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'GFRP Pipes Procurement', metaDescription: 'GFRP pipes procurement.', intentKeywords: [], signalMapping: { category: 'composites', subcategory: 'gfrp_frp', industry: 'water_chemical', buyer_type: 'industrial_epc', estimated_value_band: 'high', signal_source: 'signal_page' }, verifiedSuppliersCount: 48, successfulDealsCount: 96, typicalDealRange: { min: 8000000, max: 300000000 }, deliveryTimeline: '20–60 days' },
  { slug: 'frp-tanks-supply', canonicalSlug: 'gfrp-composites-industrial', h1: 'FRP Tanks Supply', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'FRP Tanks Supply', metaDescription: 'FRP tanks supply.', intentKeywords: [], signalMapping: { category: 'composites', subcategory: 'gfrp_frp', industry: 'water_chemical', buyer_type: 'industrial_epc', estimated_value_band: 'high', signal_source: 'signal_page' }, verifiedSuppliersCount: 48, successfulDealsCount: 96, typicalDealRange: { min: 8000000, max: 300000000 }, deliveryTimeline: '20–60 days' },
  { slug: 'frp-cable-trays', canonicalSlug: 'gfrp-composites-industrial', h1: 'FRP Cable Trays', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'FRP Cable Trays', metaDescription: 'FRP cable trays.', intentKeywords: [], signalMapping: { category: 'composites', subcategory: 'gfrp_frp', industry: 'water_chemical', buyer_type: 'industrial_epc', estimated_value_band: 'high', signal_source: 'signal_page' }, verifiedSuppliersCount: 48, successfulDealsCount: 96, typicalDealRange: { min: 8000000, max: 300000000 }, deliveryTimeline: '20–60 days' },
  { slug: 'composite-materials-industrial', canonicalSlug: 'gfrp-composites-industrial', h1: 'Composite Materials Industrial', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'Composite Materials Industrial', metaDescription: 'Industrial composite materials.', intentKeywords: [], signalMapping: { category: 'composites', subcategory: 'gfrp_frp', industry: 'water_chemical', buyer_type: 'industrial_epc', estimated_value_band: 'high', signal_source: 'signal_page' }, verifiedSuppliersCount: 48, successfulDealsCount: 96, typicalDealRange: { min: 8000000, max: 300000000 }, deliveryTimeline: '20–60 days' },

  // ============================
  // ALIAS MAPPINGS FOR USER-REQUESTED 33 CANONICAL SLUGS
  // These ensure all requested URLs resolve correctly
  // ============================

  // Cold Rolled Coils → existing canonical
  { slug: 'cold-rolled-coils', canonicalSlug: 'cold-rolled-coil-manufacturing', h1: 'Cold Rolled Coils Procurement', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'Cold Rolled Coils Procurement India', metaDescription: 'CRC bulk procurement for manufacturing.', intentKeywords: ['cold rolled coils', 'crc coils'], signalMapping: { category: 'steel', subcategory: 'cold_rolled_coil', industry: 'manufacturing', buyer_type: 'oem', estimated_value_band: 'medium_high', signal_source: 'signal_page' }, verifiedSuppliersCount: 45, successfulDealsCount: 134, typicalDealRange: { min: 3000000, max: 120000000 }, deliveryTimeline: '10–30 days' },
  
  // Cold Rolled Coil Industrial → existing canonical (old broken slug redirect)
  { slug: 'cold-rolled-coil-industrial', canonicalSlug: 'cold-rolled-coil-manufacturing', h1: 'Cold Rolled Coil Industrial', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'CRC Industrial Procurement', metaDescription: 'Industrial CRC procurement.', intentKeywords: ['cold rolled coil industrial'], signalMapping: { category: 'steel', subcategory: 'cold_rolled_coil', industry: 'manufacturing', buyer_type: 'oem', estimated_value_band: 'medium_high', signal_source: 'signal_page' }, verifiedSuppliersCount: 45, successfulDealsCount: 134, typicalDealRange: { min: 3000000, max: 120000000 }, deliveryTimeline: '10–30 days' },
  
  // Heavy Steel Plates → existing canonical (old broken slug redirect)
  { slug: 'heavy-steel-plates', canonicalSlug: 'steel-plates-heavy', h1: 'Heavy Steel Plates', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'Heavy Steel Plates Procurement', metaDescription: 'Heavy steel plates for engineering.', intentKeywords: ['heavy steel plates'], signalMapping: { category: 'steel', subcategory: 'plates', industry: 'heavy_engineering', buyer_type: 'fabricator', estimated_value_band: 'high', signal_source: 'signal_page' }, verifiedSuppliersCount: 40, successfulDealsCount: 96, typicalDealRange: { min: 5000000, max: 250000000 }, deliveryTimeline: '15–45 days' },
  
  // Aggregates → existing canonical (old broken slug redirect)
  { slug: 'aggregates', canonicalSlug: 'construction-aggregates', h1: 'Aggregates Procurement', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'Aggregates Procurement', metaDescription: 'Construction aggregates bulk supply.', intentKeywords: ['aggregates'], signalMapping: { category: 'construction', subcategory: 'aggregates', industry: 'infrastructure', buyer_type: 'contractor', estimated_value_band: 'medium', signal_source: 'signal_page' }, verifiedSuppliersCount: 40, successfulDealsCount: 120, typicalDealRange: { min: 300000, max: 25000000 }, deliveryTimeline: '2–7 days' },
  
  // Bearings → existing canonical (old broken slug redirect)
  { slug: 'bearings', canonicalSlug: 'bearings-industrial', h1: 'Bearings Procurement', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'Industrial Bearings', metaDescription: 'Bearings bulk procurement.', intentKeywords: ['bearings'], signalMapping: { category: 'hardware', subcategory: 'bearings', industry: 'manufacturing', buyer_type: 'oem', estimated_value_band: 'medium_high', signal_source: 'signal_page' }, verifiedSuppliersCount: 35, successfulDealsCount: 98, typicalDealRange: { min: 500000, max: 50000000 }, deliveryTimeline: '5–15 days' },
  
  // Gaskets → existing canonical (old broken slug redirect)
  { slug: 'gaskets', canonicalSlug: 'gaskets-seals', h1: 'Gaskets Procurement', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'Industrial Gaskets', metaDescription: 'Gaskets bulk procurement.', intentKeywords: ['gaskets'], signalMapping: { category: 'consumables', subcategory: 'gaskets', industry: 'process_industry', buyer_type: 'plant_operator', estimated_value_band: 'medium', signal_source: 'signal_page' }, verifiedSuppliersCount: 25, successfulDealsCount: 78, typicalDealRange: { min: 300000, max: 25000000 }, deliveryTimeline: '7–21 days' },
  
  // Transformers → existing canonical (old broken slug redirect)
  { slug: 'transformers', canonicalSlug: 'transformers-power', h1: 'Transformers Procurement', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'Power Transformers', metaDescription: 'Transformers procurement.', intentKeywords: ['transformers'], signalMapping: { category: 'electrical', subcategory: 'transformers', industry: 'power', buyer_type: 'utility', estimated_value_band: 'very_high', signal_source: 'signal_page' }, verifiedSuppliersCount: 25, successfulDealsCount: 45, typicalDealRange: { min: 5000000, max: 500000000 }, deliveryTimeline: '30–90 days' },

  // RMC Concrete (user-requested slug)
  // Already exists at line 1249 - no duplicate needed

  // Fly Ash (user-requested slug)  
  // Already exists at line 1323 - no duplicate needed

  // Solar Equipment Power → energy-power-equipment canonical
  { slug: 'solar-equipment-power', canonicalSlug: 'energy-power-equipment', h1: 'Solar Equipment Power Procurement', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'Solar Equipment Power Procurement', metaDescription: 'Solar power equipment supply.', intentKeywords: ['solar equipment power'], signalMapping: { category: 'energy_power', subcategory: 'power_equipment', industry: 'power_infra', buyer_type: 'epc_utility', estimated_value_band: 'very_high', signal_source: 'signal_page' }, verifiedSuppliersCount: 65, successfulDealsCount: 142, typicalDealRange: { min: 20000000, max: 800000000 }, deliveryTimeline: '20–60 days' },

  // Industrial Pipes Oil Gas → existing canonical
  { slug: 'industrial-pipes-oil-gas', canonicalSlug: 'industrial-pipes-tubes-oil-gas', h1: 'Industrial Pipes Oil Gas', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'Industrial Pipes Oil Gas', metaDescription: 'Oil and gas pipes procurement.', intentKeywords: ['industrial pipes oil gas'], signalMapping: { category: 'pipes', subcategory: 'oil_gas_pipes', industry: 'oil_gas', buyer_type: 'epc_contractor', estimated_value_band: 'very_high', signal_source: 'signal_page' }, verifiedSuppliersCount: 55, successfulDealsCount: 118, typicalDealRange: { min: 15000000, max: 600000000 }, deliveryTimeline: '25–75 days' },

  // Petroleum Bitumen → existing canonical
  { slug: 'petroleum-bitumen', canonicalSlug: 'petroleum-bitumen-procurement', h1: 'Petroleum Bitumen Procurement', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'Petroleum Bitumen Procurement', metaDescription: 'Bitumen bulk supply for roads.', intentKeywords: ['petroleum bitumen'], signalMapping: { category: 'petroleum', subcategory: 'bitumen', industry: 'roads_infra', buyer_type: 'road_contractor', estimated_value_band: 'high', signal_source: 'signal_page' }, verifiedSuppliersCount: 42, successfulDealsCount: 88, typicalDealRange: { min: 10000000, max: 400000000 }, deliveryTimeline: '7–30 days' },

  // Steel Fabrication Structures → existing canonical
  { slug: 'steel-fabrication-structures', canonicalSlug: 'steel-fabrication-structures-epc', h1: 'Steel Fabrication Structures', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'Steel Fabrication Structures', metaDescription: 'Steel fabrication for infrastructure.', intentKeywords: ['steel fabrication structures'], signalMapping: { category: 'steel_fabrication', subcategory: 'structures', industry: 'industrial_epc', buyer_type: 'epc_contractor', estimated_value_band: 'high', signal_source: 'signal_page' }, verifiedSuppliersCount: 70, successfulDealsCount: 134, typicalDealRange: { min: 12000000, max: 500000000 }, deliveryTimeline: '30–90 days' },

  // GFRP Composites → existing canonical
  { slug: 'gfrp-composites', canonicalSlug: 'gfrp-composites-industrial', h1: 'GFRP Composites Procurement', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'GFRP Composites Procurement', metaDescription: 'GFRP composite materials.', intentKeywords: ['gfrp composites'], signalMapping: { category: 'composites', subcategory: 'gfrp_frp', industry: 'water_chemical', buyer_type: 'industrial_epc', estimated_value_band: 'high', signal_source: 'signal_page' }, verifiedSuppliersCount: 48, successfulDealsCount: 96, typicalDealRange: { min: 8000000, max: 300000000 }, deliveryTimeline: '20–60 days' },

  // Pharmaceutical APIs → existing canonical
  { slug: 'pharmaceutical-apis', canonicalSlug: 'pharmaceutical-apis-intermediates', h1: 'Pharmaceutical APIs Procurement', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'Pharmaceutical APIs Procurement', metaDescription: 'Pharmaceutical APIs bulk supply.', intentKeywords: ['pharmaceutical apis'], signalMapping: { category: 'pharmaceuticals', subcategory: 'apis_intermediates', industry: 'pharmaceutical', buyer_type: 'manufacturer', estimated_value_band: 'very_high', signal_source: 'signal_page' }, verifiedSuppliersCount: 120, successfulDealsCount: 280, typicalDealRange: { min: 1000000, max: 100000000 }, deliveryTimeline: '7–30 days' },

  // Electrical Equipment → existing canonical
  { slug: 'electrical-equipment', canonicalSlug: 'electrical-equipment-power-distribution', h1: 'Electrical Equipment Procurement', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'Electrical Equipment Procurement', metaDescription: 'Electrical equipment bulk supply.', intentKeywords: ['electrical equipment'], signalMapping: { category: 'electrical_equipment', subcategory: 'power_distribution', industry: 'power_infrastructure', buyer_type: 'epc', estimated_value_band: 'very_high', signal_source: 'signal_page' }, verifiedSuppliersCount: 95, successfulDealsCount: 220, typicalDealRange: { min: 2000000, max: 150000000 }, deliveryTimeline: '15–60 days' },

  // Water Treatment Chemicals → existing canonical
  { slug: 'water-treatment-chemicals', canonicalSlug: 'water-treatment-chemicals-systems', h1: 'Water Treatment Chemicals Procurement', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'Water Treatment Chemicals Procurement', metaDescription: 'Water treatment chemicals supply.', intentKeywords: ['water treatment chemicals'], signalMapping: { category: 'water_treatment', subcategory: 'chemicals_systems', industry: 'water_infrastructure', buyer_type: 'industrial', estimated_value_band: 'high', signal_source: 'signal_page' }, verifiedSuppliersCount: 80, successfulDealsCount: 190, typicalDealRange: { min: 500000, max: 80000000 }, deliveryTimeline: '5–20 days' },

  // Industrial Storage Tanks → existing canonical
  { slug: 'industrial-storage-tanks', canonicalSlug: 'industrial-storage-tanks-silos', h1: 'Industrial Storage Tanks Procurement', subheading: '', bodyText: '', useCases: [], whatBuyerGets: [], metaTitle: 'Industrial Storage Tanks Procurement', metaDescription: 'Storage tanks bulk supply.', intentKeywords: ['industrial storage tanks'], signalMapping: { category: 'storage_tanks', subcategory: 'industrial_tanks', industry: 'process_industry', buyer_type: 'epc', estimated_value_band: 'very_high', signal_source: 'signal_page' }, verifiedSuppliersCount: 55, successfulDealsCount: 110, typicalDealRange: { min: 5000000, max: 200000000 }, deliveryTimeline: '30–90 days' },
