...
const seoContent: Record<string, CategorySEOContent> = {
  'Agriculture Equipment & Supplies': {
    ...
    applicationsH2: 'Applications Across Farming, Agri-Processing & Rural Infrastructure Projects',
  ...
  'Auto Vehicle & Accessories': {
    ...
    applicationsH2: 'Applications Across OEM Assembly, Aftermarket & Fleet Operations',
  ...
  'Food & Beverages': {
    ...
    applicationsH2: 'Applications Across Institutional Catering, Food Processing & Export Supply',
    applicationsContent: `Food & beverage procurement powers institutional catering for corporate campuses, hospitals, and hotel & restaurant chains; raw material sourcing for food processing plants and contract manufacturing (private label) brands; military and paramilitary canteen supplies (CSD); school mid-day meal program ingredients; and export consignment preparation for international buyers. Buyers require consistent batch-to-batch quality, FSSAI/HACCP compliance, and reliable cold chain logistics with temperature-controlled warehousing for dairy, frozen, and perishable categories.`,
  ...
  'Medical & Healthcare': {
    ...
    applicationsH2: 'Applications Across Hospitals, Diagnostics & Healthcare Infrastructure',
  ...
  'Pharmaceuticals & Drugs': {
    ...
    applicationsH2: 'Applications Across Drug Manufacturing, Hospital Supply & Export Markets',
  ...
  'Safety & Security': {
    ...
    applicationsH2: 'Applications Across Industrial Safety, Construction & Surveillance Infrastructure',
  ...
  'Textiles & Leather': {
    ...
    applicationsH2: 'Applications Across Apparel, Technical Textiles & Export Manufacturing',
  ...
  'Telecommunication': {
    ...
    applicationsH2: 'Applications Across 5G Rollout, Broadband & Enterprise Networking',
  ...
  'Packaging & Printing': {
    ...
    applicationsH2: 'Applications Across FMCG, Pharma, Food Export & E-commerce Packaging',
  ...
  'Solar & Renewable Energy': {
    ...
    applicationsH2: 'Applications Across Utility-Scale, C&I and Rooftop Solar Projects',
