        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-display font-bold mb-6">
              How Export–Import Sourcing Works
            </h1>
            
            <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              Learn the complete export-import sourcing process. <strong>ProcureSaathi</strong> helps buyers and suppliers 
              connect across domestic and export–import markets with verified partners and documentation support.
            </p>
