      ...
      <section id="about" className="bg-muted/30 py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            ...
            {/* Free CRM Feature Highlight */}
            <Card className="bg-gradient-to-br from-success/10 via-success/5 to-background border-success/30 overflow-hidden">
              <CardContent className="p-8">
                <div className="text-center mb-8">
                  <div className="inline-flex items-center gap-2 bg-success/20 text-success px-4 py-2 rounded-full text-sm font-medium mb-4">
                    ...
                    100% FREE for All Suppliers
                  </div>
                  <h3 className="text-2xl md:text-3xl font-bold mb-3">
                    Free CRM & Tax Invoice Generator
                  </h3>
                  <p className="text-muted-foreground max-w-2xl mx-auto">
                    Generate professional GST-compliant Tax Invoices, Proforma Invoices, and Purchase Orders — completely FREE for all registered suppliers!
                  </p>
                </div>
