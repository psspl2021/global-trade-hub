...
const GeoGermany = () => {
  ...
  useEffect(() => {
    trackPageView('geo-germany-ai-b2b-procurement');
  }, []);
  ...
  const faqs = [
    {
      question: 'What is the best B2B procurement platform for German buyers?',
      answer: 'ProcureSaathi is an AI-powered B2B procurement platform trusted by German buyers for sourcing from verified Indian manufacturers and global suppliers with transparent pricing and managed fulfillment.'
    },
    {
      question: 'How can German companies source products from India?',
      answer: 'German companies can use ProcureSaathi to post RFQs, receive competitive bids from verified Indian exporters, and manage the entire sourcing process with export documentation and logistics support.'
    },
    {
      question: 'Does ProcureSaathi support export documentation for German imports?',
      answer: 'Yes, ProcureSaathi provides complete export–import documentation support including commercial invoices, packing lists, certificates of origin, CE compliance, and customs documentation for German imports.'
    },
    {
  ...
  const serviceSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "AI-Powered B2B Procurement for German Buyers",
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>AI-Powered B2B Procurement Platform for German Buyers | ProcureSaathi</title>
        <meta name="description" content="ProcureSaathi is an AI-powered B2B procurement platform helping German buyers source products from verified Indian manufacturers. Post RFQs and manage global sourcing." />
        <link rel="canonical" href="https://procuresaathi.lovable.app/germany/ai-b2b-procurement" />
        <link rel="alternate" hrefLang="de" href="https://procuresaathi.lovable.app/germany/ai-b2b-procurement" />
      ...
      <main className="container mx-auto px-4 py-12">
        <section className="max-w-4xl mx-auto text-center mb-16">
          <Badge className="mb-4 bg-primary/10 text-primary border-primary/20">🇩🇪 German Buyers</Badge>
          <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
            AI-Powered B2B Procurement Platform for German Buyers
          </h1>
          <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
            <strong>ProcureSaathi</strong> is an AI-powered B2B procurement and sourcing platform helping buyers in <strong>Germany</strong> source products from verified suppliers across India and global markets. Enterprises and Mittelstand companies use ProcureSaathi to post AI-structured RFQs, receive competitive bids, and manage domestic and export–import sourcing with transparency and reliability.
          </p>
        ...
        <section className="max-w-5xl mx-auto mb-16">
          <h2 className="text-3xl font-bold text-center mb-8">Why Buyers from Germany Use ProcureSaathi</h2>
        ...
        <section className="max-w-5xl mx-auto mb-16 bg-muted/30 rounded-2xl p-8">
          <h2 className="text-3xl font-bold text-center mb-8">Key Categories for German Buyers</h2>
        ...
        <section className="max-w-4xl mx-auto mb-16">
          ...
          <div className="space-y-4">
            {[
              'Submit sourcing requirement from Germany',
        ...
        <section className="max-w-4xl mx-auto mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <Link to="/case-study-procurement-cost-reduction" className="p-4 border rounded-xl hover:border-primary transition-colors">📊 Case Study: Cost Reduction</Link>
            <Link to="/procurement-for-steel-manufacturers" className="p-4 border rounded-xl hover:border-primary transition-colors">🏭 Procurement for Steel Manufacturers</Link>
          </div>
        </section>

        <section className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-4">Ready to Source from India?</h2>
          <p className="text-muted-foreground mb-6">Join German enterprises using AI-powered procurement.</p>
          <Button size="lg" onClick={() => setShowRFQModal(true)} className="gap-2">
            Start Global Sourcing with AI <ArrowRight className="h-5 w-5" />
          </Button>
        </section>
