...
const GeoUK = () => {
  ...
  useEffect(() => {
    trackPageView('geo-uk-ai-b2b-procurement');
  }, []);
  ...
  const faqs = [
    {
      question: 'What is the best B2B procurement platform for UK buyers?',
      answer: 'ProcureSaathi is an AI-powered B2B procurement platform trusted by UK buyers for sourcing from verified Indian manufacturers and global suppliers with transparent pricing and managed fulfillment.'
    },
    {
      question: 'How can UK companies source products from India?',
      answer: 'UK companies can use ProcureSaathi to post RFQs, receive competitive bids from verified Indian exporters, and manage the entire sourcing process with export documentation and logistics support.'
    },
    {
      question: 'Does ProcureSaathi support export documentation for UK imports?',
      answer: 'Yes, ProcureSaathi provides complete export–import documentation support including commercial invoices, packing lists, certificates of origin, and customs compliance for UK imports.'
    },
    {
  ...
  const serviceSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "AI-Powered B2B Procurement for UK Buyers",
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>AI-Powered B2B Procurement Platform for UK Buyers | ProcureSaathi</title>
        <meta name="description" content="ProcureSaathi is an AI-powered B2B procurement platform helping UK buyers source products from verified Indian manufacturers. Post RFQs and manage global sourcing." />
        <link rel="canonical" href="https://procuresaathi.lovable.app/uk/ai-b2b-procurement" />
        <link rel="alternate" hrefLang="en-gb" href="https://procuresaathi.lovable.app/uk/ai-b2b-procurement" />
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <section className="max-w-5xl mx-auto mb-16">
          <h2 className="text-3xl font-bold text-center mb-8">Why Buyers from UK Use ProcureSaathi</h2>
        ...
        <section className="max-w-5xl mx-auto mb-16 bg-muted/30 rounded-2xl p-8">
          <h2 className="text-3xl font-bold text-center mb-8">Key Categories for UK Buyers</h2>
        ...
        <section className="max-w-4xl mx-auto mb-16">
          ...
          <div className="space-y-4">
            {[
              'Submit sourcing requirement from United Kingdom',
        ...
        <section className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-muted-foreground mb-6">Join UK enterprises using AI-powered procurement.</p>
          <Button size="lg" onClick={() => setShowRFQModal(true)} className="gap-2">
            Start Global Sourcing with AI <ArrowRight className="h-5 w-5" />
          </Button>
        </section>
