...
export const DEMO_NARRATION: NarrationEntry[] = [
  ...
  },
  {
    step: 'savings',
    text: {
      en: 'Dekho… round by round price kaise gir raha hai… yeh manual negotiation se POSSIBLE hi nahi hai. Har auction mein typically 500 se 1000 rupees per metric ton savings hoti hai… Multiple procurements ke baad… yeh 10 se 15 percent ANNUAL savings ban jaati hai.',
      hi: 'Dekho… round by round price gir raha hai… yeh manual negotiation se possible nahi. Har auction mein 500 se 1000 rupees per MT bachte hain… saal bhar mein 10 se 15 percent savings.',
    },
  },
  {
    step: 'loss_aversion',
