...
import { 
  Users, Target, FileText, TrendingUp, Globe, 
  RefreshCw, Mail, MessageSquare, ExternalLink 
} from 'lucide-react';
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Discover global buyers, generate outreach, and convert leads to RFQs
          </p>
        </div>
        ...
        <TabsContent value="overview" className="space-y-6">
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-2">
                  {Object.entries(metrics?.by_category || {}).slice(0, 10).map(([cat, count]) => (
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-2">
                  {Object.entries(metrics?.by_country || {}).slice(0, 10).map(([country, count]) => (
              ...
              <div className="flex items-center justify-between gap-2">
                {[
                  ...
                  <div key={stage.label} className="flex-1 text-center">
                    <div className={`h-16 ${stage.color} rounded flex items-center justify-center text-white font-bold text-xl`}>
                      {stage.value}
                    </div>
