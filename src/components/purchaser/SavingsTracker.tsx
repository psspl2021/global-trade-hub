 ...
 * Reward pool = 1-2% of net savings.
 */
...
export function SavingsTracker() {
  ...
  const rewardPoolPercentage = 0.015; // 1.5%
      ...
      <div className="space-y-6">
            ...
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <div>
                    <p className="text-sm text-amber-600/80 font-medium">Reward Pool</p>
                    <p className="text-2xl font-bold text-amber-700">{formatCurrency(potentialReward)}</p>
                  </div>
                  <Tooltip>
                    <TooltipTrigger>
                    ...
                    <TooltipContent className="max-w-xs">
                      <p>Your performance bonus is generated by AI-verified savings, approved by management.</p>
                    </TooltipContent>
                  </Tooltip>
                </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Each RFQ tracked with baseline vs. final price
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-gradient-to-r from-purple-50 to-indigo-50 border-purple-200">
          ...
          <CardContent>
            ...
            <p className="text-xs text-purple-600 mt-4">
              * All rewards are white-money, management-approved, and never linked to supplier payments.
            </p>
          </CardContent>
        </Card>
      </div>
