-- Fix the activate_lane_from_award function - confidence_score column is NUMERIC(3,1) so max is 99.9
...
DECLARE
  ...
  awarded_qty numeric;
BEGIN
  -- Get requirement details - use product_category since requirements table doesn't have category column
  ...
  -- NOTE: confidence_score is NUMERIC(3,1) so max value is 99.9
  ...
  VALUES (
    ...
    'buy',
    99.9,  -- Changed from 100 to 99.9 to fit NUMERIC(3,1)
    'activated',
    now(),
    awarded_value,
    awarded_qty,
