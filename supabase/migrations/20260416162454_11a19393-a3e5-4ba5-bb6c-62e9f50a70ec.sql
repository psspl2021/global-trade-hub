...
BEGIN
  ...
  -- FIX #2: Top vendor grouped by supplier_id to prevent name-variation splits
  ...
  -- FIX #3: Return NULL for insufficient baseline, not 0
  v_burn_trend := CASE
  ...
  -- ══════════════════════════════════════════
  -- PRESSURE SCORE (FIX #4: handle payable=0 + overdue>0 edge case)
  -- ══════════════════════════════════════════
  ...
  -- ══════════════════════════════════════════
  -- FINAL RESULT (FIX #3: NULL trends with insufficient_data direction)
  -- ══════════════════════════════════════════
