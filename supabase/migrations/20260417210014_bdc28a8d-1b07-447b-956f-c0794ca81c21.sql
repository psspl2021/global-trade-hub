-- =============================================================
-- FIX: Correct audit actor attribution for system escalations
-- =============================================================
...
BEGIN
  ...
  -- B) 48H ESCALATION (FIXED AUDIT ACTOR)
  FOR v_row IN
  ...
  LOOP
    ...
    -- ✅ FIX: actor_id = NULL (system action)
    INSERT INTO public.governance_audit_log(actor_id, action, entity_type, entity_id, metadata)
    VALUES (
      NULL,
