-- Drop and recreate functions with correct column names and enum values
...
BEGIN
  ...
  -- Using correct enum values: pending, accepted, rejected
  SELECT 
    b.id as bid_id,
    b.supplier_id,
...
-- Using correct column name: avg_price_per_unit (not avg_unit_price)
...
BEGIN
  ...
  -- Using correct column: avg_price_per_unit
  SELECT 
    p.supplier_id,
    scp.l1_wins,
