  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        '3xl': ['1.5rem', { lineHeight: '2rem', letterSpacing: '-0.015em' }],
        '4xl': ['1.875rem', { lineHeight: '2.25rem', letterSpacing: '-0.02em' }],
        '5xl': ['2.25rem', { lineHeight: '2.5rem', letterSpacing: '-0.02em' }],
        '6xl': ['2.75rem', { lineHeight: '1.15', letterSpacing: '-0.025em' }],
        '7xl': ['3.25rem', { lineHeight: '1.1', letterSpacing: '-0.025em' }],
      },
      colors: {
      ...
      animation: {
        ...
        "float-medium": "float 5.5s ease-in-out infinite",
